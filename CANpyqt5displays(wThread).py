...
#worker signals can go here but cba

class Worker(QRunnable):  #from python guis tutorial on threading refer and adjust ltr
    '''
    Worker thread
    ...
    @pyqtSlot()  #from python guis tutorial on threading refer and adjust ltr
    def run(self):
        '''
...
class MainWindow(QMainWindow):
    ...
    def display_update(self):
        ...
        #self.processEvents() # lazy way apparently
